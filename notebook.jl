...
# ╔═╡ 05df5b42-fa75-4e1d-bdc2-bfc546ef137d
begin
	using DataFrames
	using CSV
end

# ╔═╡ 202e2130-aa50-462c-b4c3-e4dea3dadac4
using Plots  # This will install plots

# ╔═╡ d35cf864-2475-44cb-abdf-9e04a5cf6b61
using PlutoUI

# ╔═╡ 4087b187-1da7-4769-a83b-82dd1721a22c
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 26c076ef-dc13-40cf-be96-c6749a986571
df.Country_code === df[!, "Country_code"]

# ╔═╡ 48cde701-697d-4331-91fd-d4c4965a091e
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 757e885b-6ca6-4ad6-9a77-e9f14d75a992
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 1e069bca-4dda-4a33-a5d9-6880cabe860a
dates = sg_data[!, "Date_reported"]

# ╔═╡ 7bfb3f2e-0e68-49ab-9e7f-585b01eff19b
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 24ba42a2-287e-4f96-8d52-eba17f4c555c
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ c589646c-9a18-47f2-bf7a-e93bc45c9c46
...
# ╔═╡ 9dc8fec0-d8bd-4a27-8314-bad186b246c5
@bind slider_value Slider(0:10:1000)

# ╔═╡ fbc4c043-8d2d-4067-b72a-b0d41bf00eed
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ c57c2871-c0e9-4db3-9173-6e7c88da393c
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 5b1beeec-8508-4b5b-b02a-0a3b765fecc5
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 4172e918-b0c0-436e-b61c-84b0723e630b
